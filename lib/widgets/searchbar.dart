    ...
    return Container(
            ...
            child: Column(children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Helper.text("Home", 18, 0, Colors.white,
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Helper.text("Appoinments", 18, 0, Colors.white,
                        FontWeight.normal, TextAlign.center),
                  ],
                ),
              ),
              Padding(
                ...
                child: Row(
                  children: [
                    Helper.text("Search", 18, 0, Colors.white,
                        FontWeight.normal, TextAlign.center),
                  ],
                ),
              ),
              Padding(
                ...
                child: Row(
                  children: [
                    Helper.text("Offers", 18, 0, Colors.white,
                        FontWeight.normal, TextAlign.center),
                  ],
                ),
              ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Helper.text("Who we are", 18, 0, Colors.white,
                        FontWeight.normal, TextAlign.center),
                  ],
                ),
              ),
